...
* @param {Function} [config.onFetchConfig] Async function to call when the Fetch config object has been generated. Called as `(fetchURL:String, fetchConfig:Object)`
*
...
export default function faxios(config) {
	return Promise.resolve()
		...
		.then(([fUrl, fConfig]) => fetch(fUrl, fConfig))
